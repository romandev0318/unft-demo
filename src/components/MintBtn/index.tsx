...
export const MintBtn: React.FC<Props> = ({ loading, onClick }) => {
  ...
  if (expired)
    return (
      <div className='flex p-5 mx-auto mt-6 md:mt-16 md:p-8 md:mx-0 w-auto max-w-full rounded-[19px] bg-transparent flex-col-reverse space-y-6 space-y-reverse'>
        <div className='flex space-x-[9px] md:space-x-4 opacity-0 pointer-events-none'>
  ...
  return (
    <div className='flex flex-col p-5 mx-auto mt-6 md:mt-16 md:p-8 md:mx-0 space-y-6 w-auto max-w-full rounded-[19px] bg-[#020202]/30 backdrop-blur-md'>
      <div className='flex space-x-[9px] md:space-x-4 opacity-100'>
        <div className='flex flex-col rounded-xl w-24 pt-[6px] pb-[10px] md:pt-4 md:pb-4 bg-[#020202]/40 border border-[#9D9B95]'>
          <span className='text-[22px] md:text-2xl font-semibold -mb-1 text-[#F2F2F2]'>
            {remaining.days}
          </span>
      ...
      <button type='button' disabled={true} className='btn-mint'>
